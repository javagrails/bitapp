...
<div id="login">
    <div class="inner">
        <div class="fheader">Bit App Login</div>

        <form action="/login/authenticate" method="POST" id="loginForm" class="cssform" autocomplete="off">
            <p>
                <label for="username">User Name </label>
                <input class="text_" name="username" id="username" type="text" placeholder="user name unique"/>
            </p>

            <p>
                <label for="password">Password </label>
                <input class="text_" name="password" id="password" type="password" placeholder="your password"/>
            </p>
